...
api_version: int
create_smart_ban_plugin: Literal["smart_ban"]
create_ut_metadata_plugin: Literal["ut_metadata"]
create_ut_pex_plugin: Literal["ut_pex"]
version: str
version_major: int
version_minor: int
__version__: str
...
def generate_fingerprint_bytes(
    _prefix: str | bytes, _major: int, _minor: int = 0, _rev: int = 0, _tag: int = 0
) -> bytes:
    """
    generate_fingerprint_bytes( (bytes)arg1, (int)arg2, (int)arg3, (int)arg4, (int)arg5) -> bytes :
    """
...
@overload
def list_files(path: str | bytes, flags: int = 0) -> list[create_file_entry]:
    """
    list_files( (str)path [, (object)flags=0]) -> object :
    """

@overload
def list_files(
    path: str | bytes, predicate: Callable[[str], bool], flags: int = 0
) -> list[create_file_entry]:
    """
    list_files( (str)path, (object)predicate [, (object)flags=0]) -> object :
    """
...
class announce_flags_t(metaclass=_BoostBaseClass):
    __instance_size__: int
    seed: int
    implied_port: int
    ssl_torrent: int
...
class create_file_entry(metaclass=_BoostBaseClass):
    def __init__(
        self,
        filename: str,
        size: int,
        ...
        """
        __init__( (object)arg1, (str)filename, (int)size [, (object)flags=0 [, (int)mtime=0 [, (str)symlink='']]]) -> None :
        """
...
class create_torrent(metaclass=_BoostBaseClass):
    ...
    @overload
    def __init__(
        self, files: list[create_file_entry], piece_size: int = 0, flags: int = 0
    ) -> None:
        """
        __init__( (object)arg1, (object)files [, (int)piece_size=0 [, (object)flags=0]]) -> None :
        """
    ...
    def set_creation_date(self, date: int) -> None:
        """
        set_creation_date( (create_torrent)arg1, (int)arg2) -> None :
        """
...
class file_storage(metaclass=_BoostBaseClass):
    ...
    def last_file_index_at_piece(self, piece_index_tag: int) -> int | None:
        """
        last_file_index_at_piece( (file_storage)arg1, (object)arg2) -> object :
        """
    ...
    def size_on_disk(self) -> int:
        """
        size_on_disk( (file_storage)arg1) -> int :
        """
...
class peer_info(metaclass=_BoostBaseClass):
    ...
    def local_endpoint(self) -> tuple[str, int]:
        """
        local_endpoint( (peer_info)arg1) -> tuple :
        """

    def remote_endpoint(self) -> tuple[str, int]:
        """
        remote_endpoint( (peer_info)arg1) -> tuple :
        """
...
class session(metaclass=_BoostBaseClass):
    ...
    def session_state(self, flags: int = 4294967295) -> session_params:
        """
        session_state( (session)arg1 [, (object)flags=4294967295]) -> session_params :
        """
...
class torrent_info(metaclass=_BoostBaseClass):
    ...
    def size_on_disk(self) -> int:
        """
        size_on_disk( (torrent_info)arg1) -> int :
        """
...
class torrent_status(metaclass=_BoostBaseClass):
    ...
    @property
    def need_save_resume_data(self) -> int: ...
    @property
...
class close_reason_t(int):
    blocked: int
    corrupt_pieces: int
    duplicate_peer_id: int
    encryption_error: int
    invalid_allow_fast_message: int
    invalid_bitfield_message: int
    invalid_cancel_message: int
    invalid_choke_message: int
    invalid_dht_port_message: int
    invalid_dont_have_message: int
    invalid_extended_message: int
    invalid_have_all_message: int
    invalid_have_message: int
    invalid_have_none_message: int
    invalid_info_hash: int
    invalid_interested_message: int
    invalid_message: int
    invalid_message_id: int
    invalid_metadata: int
    invalid_metadata_message: int
    invalid_metadata_offset: int
    invalid_metadata_request_message: int
    invalid_not_interested_message: int
    invalid_pex_message: int
    invalid_piece_message: int
    invalid_reject_message: int
    invalid_request_message: int
    invalid_suggest_message: int
    invalid_unchoke_message: int
    message_too_big: int
    metadata_too_big: int
    no_memory: int
    none: int
    not_interested_upload_only: int
    peer_churn: int
    pex_message_too_big: int
    pex_too_frequent: int
    port_blocked: int
    protocol_blocked: int
    request_when_choked: int
    self_connection: int
    timed_out_activity: int
    timed_out_handshake: int
    timed_out_interest: int
    timed_out_request: int
    timeout: int
    too_many_connections: int
    too_many_files: int
    torrent_removed: int
    upload_to_upload: int

    names: Final[dict[str, int]] = {
        "none": none,  # noqa: F821
        "duplicate_peer_id": duplicate_peer_id,  # noqa: F821
        "torrent_removed": torrent_removed,  # noqa: F821
        "no_memory": no_memory,  # noqa: F821
        "port_blocked": port_blocked,  # noqa: F821
        "blocked": blocked,  # noqa: F821
        "upload_to_upload": upload_to_upload,  # noqa: F821
        "not_interested_upload_only": not_interested_upload_only,  # noqa: F821
        "timeout": timeout,  # noqa: F821
        "timed_out_interest": timed_out_interest,  # noqa: F821
        "timed_out_activity": timed_out_activity,  # noqa: F821
        "timed_out_handshake": timed_out_handshake,  # noqa: F821
        "timed_out_request": timed_out_request,  # noqa: F821
        "protocol_blocked": protocol_blocked,  # noqa: F821
        "peer_churn": peer_churn,  # noqa: F821
        "too_many_connections": too_many_connections,  # noqa: F821
        "too_many_files": too_many_files,  # noqa: F821
        "encryption_error": encryption_error,  # noqa: F821
        "invalid_info_hash": invalid_info_hash,  # noqa: F821
        "self_connection": self_connection,  # noqa: F821
        "invalid_metadata": invalid_metadata,  # noqa: F821
        "metadata_too_big": metadata_too_big,  # noqa: F821
        "message_too_big": message_too_big,  # noqa: F821
        "invalid_message_id": invalid_message_id,  # noqa: F821
        "invalid_message": invalid_message,  # noqa: F821
        "invalid_piece_message": invalid_piece_message,  # noqa: F821
        "invalid_have_message": invalid_have_message,  # noqa: F821
        "invalid_bitfield_message": invalid_bitfield_message,  # noqa: F821
        "invalid_choke_message": invalid_choke_message,  # noqa: F821
        "invalid_unchoke_message": invalid_unchoke_message,  # noqa: F821
        "invalid_interested_message": invalid_interested_message,  # noqa: F821
        "invalid_not_interested_message": invalid_not_interested_message,  # noqa: F821
        "invalid_request_message": invalid_request_message,  # noqa: F821
        "invalid_reject_message": invalid_reject_message,  # noqa: F821
        "invalid_allow_fast_message": invalid_allow_fast_message,  # noqa: F821
        "invalid_extended_message": invalid_extended_message,  # noqa: F821
        "invalid_cancel_message": invalid_cancel_message,  # noqa: F821
        "invalid_dht_port_message": invalid_dht_port_message,  # noqa: F821
        "invalid_suggest_message": invalid_suggest_message,  # noqa: F821
        "invalid_have_all_message": invalid_have_all_message,  # noqa: F821
        "invalid_dont_have_message": invalid_dont_have_message,  # noqa: F821
        "invalid_have_none_message": invalid_have_none_message,  # noqa: F821
        "invalid_pex_message": invalid_pex_message,  # noqa: F821
        "invalid_metadata_request_message": invalid_metadata_request_message,  # noqa: F821
        "invalid_metadata_message": invalid_metadata_message,  # noqa: F821
        "invalid_metadata_offset": invalid_metadata_offset,  # noqa: F821
        "request_when_choked": request_when_choked,  # noqa: F821
        "corrupt_pieces": corrupt_pieces,  # noqa: F821
        "pex_message_too_big": pex_message_too_big,  # noqa: F821
        "pex_too_frequent": pex_too_frequent,  # noqa: F821
    }
    values: Final[dict[int, int]] = {
        0: none,  # noqa: F821
        1: duplicate_peer_id,  # noqa: F821
        2: torrent_removed,  # noqa: F821
        3: no_memory,  # noqa: F821
        4: port_blocked,  # noqa: F821
        5: blocked,  # noqa: F821
        6: upload_to_upload,  # noqa: F821
        7: not_interested_upload_only,  # noqa: F821
        8: timeout,  # noqa: F821
        9: timed_out_interest,  # noqa: F821
        10: timed_out_activity,  # noqa: F821
        11: timed_out_handshake,  # noqa: F821
        12: timed_out_request,  # noqa: F821
        13: protocol_blocked,  # noqa: F821
        14: peer_churn,  # noqa: F821
        15: too_many_connections,  # noqa: F821
        16: too_many_files,  # noqa: F821
        256: encryption_error,  # noqa: F821
        257: invalid_info_hash,  # noqa: F821
        258: self_connection,  # noqa: F821
        259: invalid_metadata,  # noqa: F821
        260: metadata_too_big,  # noqa: F821
        261: message_too_big,  # noqa: F821
        262: invalid_message_id,  # noqa: F821
        263: invalid_message,  # noqa: F821
        264: invalid_piece_message,  # noqa: F821
        265: invalid_have_message,  # noqa: F821
        266: invalid_bitfield_message,  # noqa: F821
        267: invalid_choke_message,  # noqa: F821
        268: invalid_unchoke_message,  # noqa: F821
        269: invalid_interested_message,  # noqa: F821
        270: invalid_not_interested_message,  # noqa: F821
        271: invalid_request_message,  # noqa: F821
        272: invalid_reject_message,  # noqa: F821
        273: invalid_allow_fast_message,  # noqa: F821
        274: invalid_extended_message,  # noqa: F821
        275: invalid_cancel_message,  # noqa: F821
        276: invalid_dht_port_message,  # noqa: F821
        277: invalid_suggest_message,  # noqa: F821
        278: invalid_have_all_message,  # noqa: F821
        279: invalid_dont_have_message,  # noqa: F821
        280: invalid_have_none_message,  # noqa: F821
        281: invalid_pex_message,  # noqa: F821
        282: invalid_metadata_request_message,  # noqa: F821
        283: invalid_metadata_message,  # noqa: F821
        284: invalid_metadata_offset,  # noqa: F821
        285: request_when_choked,  # noqa: F821
        286: corrupt_pieces,  # noqa: F821
        287: pex_message_too_big,  # noqa: F821
        288: pex_too_frequent,  # noqa: F821
    }

class dht_module_t(int):
    node: int
    routing_table: int
    rpc_manager: int
    tracker: int
    ...
    names: Final[dict[str, int]] = {
        "tracker": tracker,  # noqa: F821
        "node": node,  # noqa: F821
        "routing_table": routing_table,  # noqa: F821
        "rpc_manager": rpc_manager,  # noqa: F821
        "traversal": traversal,  # noqa: F821
    }
    values: Final[dict[int, int]] = {
        0: tracker,  # noqa: F821
        1: node,  # noqa: F821
        2: routing_table,  # noqa: F821
        3: rpc_manager,  # noqa: F821
        4: traversal,  # noqa: F821
    }

class picker_flags_t(metaclass=_BoostBaseClass):
    __instance_size__: int
    backup1: int
    backup2: int
    end_game: int
